...
package gbi_poc_work.job_msg_box_0_1;
...
/**
 * Job: job_msg_box Purpose: <br>
 * Description:  <br>
 * @author rohit.londhe@nissanmotor.com
 * @version 7.2.1.20190909_1035-patch
 * @status 
 */
public class job_msg_box implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_msg_box.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(job_msg_box.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_msg_box";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Yqw3AOYBEemqfKZd51UjiA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_msg_box.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GBI_POC_WORK_job_msg_box = new byte[0];
    static byte[] commonByteArray_GBI_POC_WORK_job_msg_box = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GBI_POC_WORK_job_msg_box.length) {
				if(length < 1024 && commonByteArray_GBI_POC_WORK_job_msg_box.length == 0) {
   					commonByteArray_GBI_POC_WORK_job_msg_box = new byte[1024];
				} else {
   					commonByteArray_GBI_POC_WORK_job_msg_box = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GBI_POC_WORK_job_msg_box, 0, length);
			strReturn = new String(commonByteArray_GBI_POC_WORK_job_msg_box, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GBI_POC_WORK_job_msg_box) {
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		row1.newColumn = "Rohit";
    	            	        	            	
    	            		row1.newColumn1 = "Londhe";
    	            	        	            	
    	            		row1.newColumn2 = "Pune";
...
///////////////////////		
	    		...
	    		if(row1.newColumn2 != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.newColumn2)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final job_msg_box job_msg_boxClass = new job_msg_box();

        int exitCode = job_msg_boxClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job_msg_box' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'job_msg_box' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = job_msg_box.class.getClassLoader().getResourceAsStream("gbi_poc_work/job_msg_box_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_msg_box.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_msg_box");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     47843 characters generated by Talend Cloud Real-Time Big Data Platform 
 *     on the February 3, 2020 7:39:15 AM GMT
 ************************************************************************************************/