 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_sample_job_CICD_test_In_Jenkins.class.getClassLoader().getResourceAsStream("gbi_poc_work/job_sample_job_cicd_test_in_jenkins_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the February 3, 2020 7:39:13 AM GMT
 ************************************************************************************************/