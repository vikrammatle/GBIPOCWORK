...
package gbi_poc_work.job_sample_job_cicd_test_in_jenkins_0_2;
...
/**
 * Job: job_sample_job_CICD_test_In_Jenkins Purpose: This job is designed for Vikram MAtle<br>
 * Description:  <br>
...
public class job_sample_job_CICD_test_In_Jenkins implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_sample_job_CICD_test_In_Jenkins.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(job_sample_job_CICD_test_In_Jenkins.class);
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_k97gEEM7EeqcK5YncCVhLA", "0.2");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_sample_job_CICD_test_In_Jenkins.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void jl_print_1_tJava_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void jl_print_1_tJava_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
	    ...
	    if (null != talendDataSources_tRunJob_1) {
			...
			log.info("tRunJob_1 - The child job 'gbi_poc_work.job_msg_box_0_1.job_msg_box' starts on the version '0.1' with the context 'Default'.");
 ...
 */
	...
	Object obj_tRunJob_2 = null;
	    ...
	    if (null != talendDataSources_tRunJob_2) {
			...
			log.info("tRunJob_2 - The child job 'gbi_poc_work.job_try_talend_functions__0_1.job_try_talend_functions_' starts on the version '0.1' with the context 'Default'.");
		...
		String[][] childReturn_tRunJob_2 = childJob_tRunJob_2.runJob((String[]) paraList_tRunJob_2.toArray(new String[paraList_tRunJob_2.size()]));
			...
			log.info("tRunJob_2 - The child job 'gbi_poc_work.job_try_talend_functions__0_1.job_try_talend_functions_' is done.");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_sample_job_CICD_test_In_Jenkins.class.getClassLoader().getResourceAsStream("gbi_poc_work/job_sample_job_cicd_test_in_jenkins_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_sample_job_CICD_test_In_Jenkins.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;jl_print_1_tJava_1Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_sample_job_CICD_test_In_Jenkins");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     53007 characters generated by Talend Cloud Real-Time Big Data Platform 
 *     on the February 3, 2020 7:39:16 AM GMT
 ************************************************************************************************/